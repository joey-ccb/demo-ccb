...
public class Test {
    ...
    public static void main(String[] args) {
        LocalDateTime localDateTime = LocalDateTime.of(2030, 11, 15, 16, 00);
        System.out.println(localDateTime.toLocalDate().toEpochDay());
        System.out.println(LocalDate.ofEpochDay(22233));
        System.out.println(2147483647);
        System.out.println(LocalDateTime.ofEpochSecond(localDateTime.toEpochSecond(ZoneOffset.UTC), 0, ZoneOffset.UTC));
//        System.out.println(ldt.toInstant(ZoneOffset.of("+8")).toEpochMilli());
//
//        DateTimeFormatter dateToStrFormatter = DateTimeFormatter.ofPattern("yyyyMMddHHmm");
//        String dateStr = dateToStrFormatter.format(ldt);
//        System.out.println(dateStr);
//        LocalDateTime ldt2 = LocalDateTime.ofInstant(ldt.toInstant(ZoneOffset.of("+8")), ZoneId.systemDefault());
